...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.emsi.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.emsi.org/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://ws.emsi.org/", "compte");
    private static final QName _GetCompte_QNAME = new QName("http://ws.emsi.org/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.emsi.org/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.emsi.org/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.emsi.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "listComptesResponse")
