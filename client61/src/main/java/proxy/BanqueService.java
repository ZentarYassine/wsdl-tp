...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listComptes", targetNamespace = "http://ws.emsi.org/", className = "proxy.ListComptes")
    @ResponseWrapper(localName = "listComptesResponse", targetNamespace = "http://ws.emsi.org/", className = "proxy.ListComptesResponse")
    @Action(input = "http://ws.emsi.org/BanqueService/listComptesRequest", output = "http://ws.emsi.org/BanqueService/listComptesResponse")
